...
- [ ] **cycloidal_pendulum_huygens** — see `BACKLOG.md` for hints
- [ ] **rolling_chain** — see `BACKLOG.md` for hints
- [ ] **centrifugal_governor** — see `BACKLOG.md` for hints
- [ ] **pulley_with_inertia** — see `BACKLOG.md` for hints
- [ ] **n_body_1d_collisions** — see `BACKLOG.md` for hints
- [ ] **block_on_accelerating_wedge** — see `BACKLOG.md` for hints
- [ ] **pendulum_with_lateral_spring** — see `BACKLOG.md` for hints
- [ ] **hanging_slinky_drop** — see `BACKLOG.md` for hints
- [ ] **standing_wave_on_string** — see `BACKLOG.md` for hints
- [ ] **belt_friction** — see `BACKLOG.md` for hints
- [ ] **block_on_block_static_friction** — see `BACKLOG.md` for hints
- [ ] **tumbling_book** — see `BACKLOG.md` for hints
- [ ] **swinging_chain_pendulum** — see `BACKLOG.md` for hints
- [ ] **bead_in_rotating_ring** — see `BACKLOG.md` for hints
- [ ] **block_and_tackle** — see `BACKLOG.md` for hints
- [ ] **cantilever_load_curve** — see `BACKLOG.md` for hints
- [ ] **symmetry_breaking_ball_on_dome** — see `BACKLOG.md` for hints
